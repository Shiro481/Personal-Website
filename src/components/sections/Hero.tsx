...
const Hero: React.FC = () => {
    return (
        <section className="bg-bg relative overflow-hidden text-text-primary min-h-screen flex items-center justify-center p-4 lg:p-16">
            ...
            <div className="container mx-auto max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                    ...
                    <div className="inline-flex items-center px-4 py-2 rounded-full border border-primary/30 bg-primary/10">
                        <span className="text-primary text-sm font-sans uppercase tracking-wider">Available as an intern</span>
                    </div>

                    {/* Heading */}
                    <div className="space-y-2">
                        <h1 className="text-6xl lg:text-8xl font-bold font-poppins leading-tight text-text-primary">
                            Creative <br />
                    ...
                    {/* Subtext */}
                    <p className="text-text-secondary text-lg lg:text-xl font-sans max-w-lg leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="#projects" className="bg-primary hover:bg-primary/90 text-black font-bold py-4 px-8 rounded-xl shadow-[0_0_20px_0_rgba(61,188,255,0.4)] transition-all">
                            View My Work
                        </a>
                        <a href="#contact" className="bg-bg-card border border-border hover:bg-border text-text-primary font-sans text-base py-4 px-8 rounded-xl transition-all">
                            Contact Me
                        </a>
                    </div>
                </div>
